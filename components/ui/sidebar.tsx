      ...
      <div
        ...
        className={cn(
          ...
          variant === "floating" || variant === "inset"
            ...
            : "group-data-[collapsible=icon]:w-(--sidebar-width-icon) group-data-[side=left]:border-r group-data-[side=right]:border-l data-[side=left]:border-r data-[side=right]:border-l border-sidebar-border",
          className
        )}
        {...props}
      >
...
function SidebarSeparator({
  ...
  return (
    <Separator
      ...
      className={cn("w-full bg-sidebar-border/70", className)}
      {...props}
    />
  )
}
